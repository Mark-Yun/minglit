---
source_url: https://github.com/Mark-Yun/minglit/issues/1632
captured_at: 2026-04-19
issue_number: 1632
state: closed
labels: [bug-report, needs-qa, from-app, report-runtime-qa]
author: Mark-Yun
title: "[Bug Report] [QA] U-S01 — No events for logged-in user"
---

# [Bug Report] [QA] U-S01 — No events for logged-in user

> Issue #1632 · closed · created 2026-04-19T21:20:27Z · author @Mark-Yun
> https://github.com/Mark-Yun/minglit/issues/1632
...
**Description:**
Home screen shows No recommended events for a logged-in dev user (18여_강남), while events were visible for a GUEST user. Possible filtering or permission issue in event fetching.

**Environment:**
- Platform: android
- Timestamp: 2026-04-19T17:20:28.794504
...
[D] TIME: 2026-04-19T17:20:28.707022 ✅ Upload bytes success: https://cnuahgrfzcqkmdyhunuk.supabase.co/storage/v1/object/public/bug-report-attachments/screenshots/f63ca5b5-e128-492d-8700-c3475ade9175.png
[D] TIME: 2026-04-19T17:20:28.793631 ✅ Upload bytes success: https://cnuahgrfzcqkmdyhunuk.supabase.co/storage/v1/object/public/bug-report-attachments/layout-dumps/14f8ea0f-2a6f-430c-aff0-cfbb374449bf.txt
```
...
## Screenshot
![Screenshot](https://cnuahgrfzcqkmdyhunuk.supabase.co/storage/v1/object/public/bug-report-attachments/screenshots/f63ca5b5-e128-492d-8700-c3475ade9175.png)
...
## Layout Dump
[📐 View Layout Dump](https://cnuahgrfzcqkmdyhunuk.supabase.co/storage/v1/object/public/bug-report-attachments/layout-dumps/14f8ea0f-2a6f-430c-aff0-cfbb374449bf.txt)
...
#1634와 동일한 근본 원인으로 보임 (getTodayActiveEventsForUser | count: 0). 진단 후 중복 통합 또는 별개 이슈로 처리하겠습니다.

### Comment 2 — @Mark-Yun on 2026-04-19

## 🔍 진단 완료 — #1634와 동일 원인

본 이슈와 #1634는 동일 세션(runtime-qa-smoke-user-sonnet-subagents 20260420-060101), 동일 dev user (`ef5c49d1-eb53-46db-8087-fde4b4e80e5e` / user_18_f_강남), 동일 로그 패턴 (`getEventsByType: 4` vs `홈 표시: 0`).

**#1634가 더 상세한 impact(U-S01/S03/S04/S05 블록)를 기술하고 있음** → 본 이슈를 duplicate로 닫고 #1634로 통합. 상세 root cause 분석 + 테스트 계획은 https://github.com/Mark-Yun/minglit/issues/1634#issuecomment-4276937244 참조.

Closing as duplicate of #1634.

### Comment 3 — @Mark-Yun on 2026-04-19

Closed as duplicate of #1634. needs-qa-claude-1.
