...
|--------|-----------------|
| `event_bottom_ticket_bar` | 17 |
| `my_tickets_page` | 3 |
| `ticket_create_page` | 5 |
| `ticket_edit_page` | 6 |
| `ticket_qr_screen` | 5 |
...
| 점검 | 결과 |
|------|------|
| mds-emulator-render `_registry.dart` 미등록 screen (uncovered) | 모든 ticket screen — `docs/infra/mds-emulator-render/`에 home_page 외 미등록 |
