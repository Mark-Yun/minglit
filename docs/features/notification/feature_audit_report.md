...
|--------|-----------------|
| `notification_list_screen` | 5 |
| `notification_settings_screen` | 6 |
...
| 점검 | 결과 |
|------|------|
| mds-emulator-render `_registry.dart` 미등록 screen (uncovered) | 모든 notification screen — `docs/infra/mds-emulator-render/`에 home_page 외 미등록 |
