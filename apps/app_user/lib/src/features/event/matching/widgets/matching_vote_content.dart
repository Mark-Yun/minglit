...
// Fix #658: MatchingVoteScreen에서 Scaffold body를 독립 위젯으로 추출 — 바텀시트 임베드 지원
/// Scaffold-free matching vote UI.
/// Embeddable in bottom sheets or any container without its own Scaffold.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: [
        ...
        // Fix #690: error state — show disabled indicator instead of blank
        else if (voteMetaError)
          Padding(
