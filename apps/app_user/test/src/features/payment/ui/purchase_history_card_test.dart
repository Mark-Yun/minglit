...
void main() {
  ...
  group('PurchaseHistoryCard — list 요약 전용 회귀 테스트', () {
    testWidgets('환불 가능 케이스여도 인라인 액션 버튼을 노출하지 않는다', (tester) async {
      final mockHistory = [
        EventApplication(
          id: 'app1',
          eventId: 'event1',
          ...
          event: Event(
            id: 'event1',
            partyId: 'party1',
            startTime: DateTime(2030, 5, 1, 19),
            endTime: DateTime(2030, 5, 1, 21),
            createdAt: DateTime(2026, 4),
            updatedAt: DateTime(2026, 4),
            title: 'Paid Event',
          ),
