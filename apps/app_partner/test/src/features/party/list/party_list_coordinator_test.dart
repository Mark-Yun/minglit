...
void main() {
  group('PartyListCoordinator', () {
    ...
    test('goToCreateEvent pushes /more/parties/<partyId>/events/create', () {
      coordinator.goToCreateEvent('party-123');
      verify(
        () => mockRouter.push('/more/parties/party-123/events/create'),
      ).called(1);
    });
