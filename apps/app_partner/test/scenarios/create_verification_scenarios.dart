...
class CreateVerificationScenarios {
  static PartnerScreenshotScenario _scenario({
  ...
  static List<PartnerScreenshotScenario> get all => [
    _scenario(
      name: 'create_verification_page_empty',
      state: const CreateVerificationState(),
    ),
    _scenario(
      name: 'create_verification_page_with_fields',
      state: const CreateVerificationState(
