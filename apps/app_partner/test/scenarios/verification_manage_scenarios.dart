...
class VerificationManageScenarios {
  static final _baseTime = DateTime(2026, 4, 2, 15);

  static VerificationManageState get _withItemsState => VerificationManageState(
    active: [
      Verification(
      ...
      Verification(
        ...
        createdAt: _baseTime.subtract(const Duration(days: 1)),
      ),
    ],
    archived: [
      Verification(
        ...
        isActive: false,
        createdAt: _baseTime.subtract(const Duration(days: 5)),
      ),
    ],
  );
  ...
  static List<PartnerScreenshotScenario> get all => [
    PartnerScreenshotScenario(
      name: 'verification_manage_page_with_items',
      page: const VerificationManagePage(),
      overrides: [
        verificationManageControllerProvider.overrideWith(
          () => _VerificationManageGoldenController(_withItemsState),
        ),
      ],
    ),
    PartnerScreenshotScenario(
      name: 'verification_manage_page_empty',
      page: const VerificationManagePage(),
      overrides: [
        verificationManageControllerProvider.overrideWith(
