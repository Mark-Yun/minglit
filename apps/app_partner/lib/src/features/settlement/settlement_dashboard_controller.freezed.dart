...
mixin _$SettlementDashboardState {
  ...
  $SettlementDashboardStateCopyWith<SettlementDashboardState> get copyWith =>
      _$SettlementDashboardStateCopyWithImpl<SettlementDashboardState>(
          this as SettlementDashboardState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SettlementDashboardState &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, selectedMonth, status,
...
abstract mixin class $SettlementDashboardStateCopyWith<$Res> {
  factory $SettlementDashboardStateCopyWith(SettlementDashboardState value,
          $Res Function(SettlementDashboardState) _then) =
      _$SettlementDashboardStateCopyWithImpl;
  @useResult
  $Res call(
...
extension SettlementDashboardStatePatterns on SettlementDashboardState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SettlementDashboardState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime selectedMonth, AsyncValue<void> status,
            Map<String, dynamic>? dashboardData)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SettlementDashboardState() when $default != null:
        return $default(_that.selectedMonth, _that.status, _that.dashboardData);
      case _:
        return orElse();
    }
  }
...
class _SettlementDashboardState implements SettlementDashboardState {
  const _SettlementDashboardState(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SettlementDashboardStateCopyWith<_SettlementDashboardState> get copyWith =>
      __$SettlementDashboardStateCopyWithImpl<_SettlementDashboardState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SettlementDashboardState &&
            (identical(other.selectedMonth, selectedMonth) ||
                other.selectedMonth == selectedMonth) &&
            (identical(other.status, status) || other.status == status) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$SettlementDashboardStateCopyWith<$Res>
    implements $SettlementDashboardStateCopyWith<$Res> {
  factory _$SettlementDashboardStateCopyWith(_SettlementDashboardState value,
          $Res Function(_SettlementDashboardState) _then) =
      __$SettlementDashboardStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {DateTime selectedMonth,
