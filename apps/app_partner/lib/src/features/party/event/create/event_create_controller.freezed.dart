...
$EventCreateStateCopyWith<EventCreateState> get copyWith => _$EventCreateStateCopyWithImpl<EventCreateState>(this as EventCreateState, _$identity);
...
@override
int get hashCode => Object.hash(runtimeType,partyId,startTime,endTime,maxParticipants,title,const DeepCollectionEquality().hash(description),imageUrl,locationId,selectedLocation,addressDetail,directionsGuide,const DeepCollectionEquality().hash(contactOptions),const DeepCollectionEquality().hash(entryGroups),const DeepCollectionEquality().hash(tickets),status);

@override
String toString() {
  return 'EventCreateState(partyId: $partyId, startTime: $startTime, endTime: $endTime, maxParticipants: $maxParticipants, title: $title, description: $description, imageUrl: $imageUrl, locationId: $locationId, selectedLocation: $selectedLocation, addressDetail: $addressDetail, directionsGuide: $directionsGuide, contactOptions: $contactOptions, entryGroups: $entryGroups, tickets: $tickets, status: $status)';
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EventCreateState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EventCreateState value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EventCreateState value)?  $default,){
final _that = this;
switch (_that) {
case _EventCreateState() when $default != null:
return $default(_that);case _:
...
@override@JsonKey() Map<String, dynamic> get contactOptions {
...
@pragma('vm:prefer-inline')
_$EventCreateStateCopyWith<_EventCreateState> get copyWith => __$EventCreateStateCopyWithImpl<_EventCreateState>(this, _$identity);
...
/// @nodoc
abstract mixin class _$EventCreateStateCopyWith<$Res> implements $EventCreateStateCopyWith<$Res> {
