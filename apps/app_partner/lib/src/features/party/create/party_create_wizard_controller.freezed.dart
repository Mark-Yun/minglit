...
mixin _$PartyCreateWizardState {
  PartyCreateStep get currentStep;
  bool get isPrefilled;
  String? get editingPartyId; // Step 1: Basic Info
  String get title;
  Map<String, dynamic> get description;
  List<String> get imageUrls;
  List<XFile> get imageFiles; // Step 2: Location
  Location? get selectedLocation;
  String get addressDetail;
  String get directionsGuide; // Step 3: Capacity & Contact
  int get minConfirmedCount;
  int get maxParticipants;
  String get contactPhone;
  String get contactEmail;
  String? get contactKakao;
  Set<String> get enabledContactMethods;
  bool get balanceEnabled;
  int get balanceTolerance; // Step 4: Entry Rules (Entry Groups)
  List<EntryGroupTemplate> get entryGroups; // Step 5: Ticket Templates
  List<TicketTemplate> get tickets;
  String get visibility; // Global Status
  ...
  $PartyCreateWizardStateCopyWith<PartyCreateWizardState> get copyWith =>
      _$PartyCreateWizardStateCopyWithImpl<PartyCreateWizardState>(
          this as PartyCreateWizardState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PartyCreateWizardState &&
            (identical(other.currentStep, currentStep) ||
                other.currentStep == currentStep) &&
            (identical(other.isPrefilled, isPrefilled) ||
                other.isPrefilled == isPrefilled) &&
            (identical(other.editingPartyId, editingPartyId) ||
                other.editingPartyId == editingPartyId) &&
            ...
            (identical(other.contactKakao, contactKakao) ||
                other.contactKakao == contactKakao) &&
            const DeepCollectionEquality()
                .equals(other.enabledContactMethods, enabledContactMethods) &&
            (identical(other.balanceEnabled, balanceEnabled) ||
                other.balanceEnabled == balanceEnabled) &&
            (identical(other.balanceTolerance, balanceTolerance) ||
                other.balanceTolerance == balanceTolerance) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hashAll([
        ...
        contactEmail,
        contactKakao,
        const DeepCollectionEquality().hash(enabledContactMethods),
        balanceEnabled,
        balanceTolerance,
...
abstract mixin class $PartyCreateWizardStateCopyWith<$Res> {
  factory $PartyCreateWizardStateCopyWith(PartyCreateWizardState value,
          $Res Function(PartyCreateWizardState) _then) =
      _$PartyCreateWizardStateCopyWithImpl;
  @useResult
  $Res call(
      {PartyCreateStep currentStep,
      bool isPrefilled,
      ...
      int minConfirmedCount,
      int maxParticipants,
      String contactPhone,
      String contactEmail,
      String? contactKakao,
      Set<String> enabledContactMethods,
      bool balanceEnabled,
      int balanceTolerance,
      List<EntryGroupTemplate> entryGroups,
      List<TicketTemplate> tickets,
      String visibility,
...
class _$PartyCreateWizardStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? isPrefilled = null,
    Object? editingPartyId = freezed,
    Object? title = null,
    ...
    Object? directionsGuide = null,
    Object? minConfirmedCount = null,
    Object? maxParticipants = null,
    Object? contactPhone = null,
    Object? contactEmail = null,
    Object? contactKakao = freezed,
    Object? enabledContactMethods = null,
    Object? balanceEnabled = null,
    Object? balanceTolerance = null,
    ...
    return _then(_self.copyWith(
      currentStep: null == currentStep
          ...
          : currentStep // ignore: cast_nullable_to_non_nullable
              as PartyCreateStep,
      isPrefilled: null == isPrefilled
          ? _self.isPrefilled
          : isPrefilled // ignore: cast_nullable_to_non_nullable
              as bool,
      editingPartyId: freezed == editingPartyId
          ? _self.editingPartyId
          : editingPartyId // ignore: cast_nullable_to_non_nullable
              as String?,
      title: null == title
          ? _self.title
      ...
      addressDetail: null == addressDetail
          ...
          : addressDetail // ignore: cast_nullable_to_non_nullable
              as String,
      directionsGuide: null == directionsGuide
      ...
      contactEmail: null == contactEmail
          ...
          : contactEmail // ignore: cast_nullable_to_non_nullable
              as String,
      contactKakao: freezed == contactKakao
          ? _self.contactKakao
          : contactKakao // ignore: cast_nullable_to_non_nullable
              as String?,
      enabledContactMethods: null == enabledContactMethods
          ? _self.enabledContactMethods
          : enabledContactMethods // ignore: cast_nullable_to_non_nullable
              as Set<String>,
      balanceEnabled: null == balanceEnabled
          ? _self.balanceEnabled
          : balanceEnabled // ignore: cast_nullable_to_non_nullable
              as bool,
      balanceTolerance: null == balanceTolerance
          ? _self.balanceTolerance
          : balanceTolerance // ignore: cast_nullable_to_non_nullable
              as int,
...
extension PartyCreateWizardStatePatterns on PartyCreateWizardState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PartyCreateWizardState value)? $default, {
    ...
    switch (_that) {
      case _PartyCreateWizardState() when $default != null:
        return $default(
            ...
            _that.contactEmail,
            _that.contactKakao,
            _that.enabledContactMethods,
            _that.balanceEnabled,
            _that.balanceTolerance,
            _that.entryGroups,
            _that.tickets,
            _that.visibility,
            _that.status);
...
class _PartyCreateWizardState implements PartyCreateWizardState {
  const _PartyCreateWizardState(
      {this.currentStep = PartyCreateStep.basicInfo,
      ...
      this.minConfirmedCount = 5,
      this.maxParticipants = 0,
      this.contactPhone = '',
      this.contactEmail = '',
      this.contactKakao,
      final Set<String> enabledContactMethods = const {},
      this.balanceEnabled = false,
      this.balanceTolerance = 2,
      final List<EntryGroupTemplate> entryGroups = const [],
      final List<TicketTemplate> tickets = const [],
      this.visibility = 'public',
      this.status = const AsyncValue.data(null)})
      : _description = description,
        _imageUrls = imageUrls,
        _imageFiles = imageFiles,
        _enabledContactMethods = enabledContactMethods,
        _entryGroups = entryGroups,
        _tickets = tickets;

  @override
  @JsonKey()
  final PartyCreateStep currentStep;
  @override
  @JsonKey()
  final bool isPrefilled;
  @override
  final String? editingPartyId;
// Step 1: Basic Info
  @override
  @JsonKey()
  final String title;
...
// Step 3: Capacity & Contact
  ...
  @JsonKey()
  Set<String> get enabledContactMethods {
    if (_enabledContactMethods is EqualUnmodifiableSetView)
      return _enabledContactMethods;
    // ignore: implicit_dynamic_type
...
// Global Status
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PartyCreateWizardStateCopyWith<_PartyCreateWizardState> get copyWith =>
      __$PartyCreateWizardStateCopyWithImpl<_PartyCreateWizardState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PartyCreateWizardState &&
            (identical(other.currentStep, currentStep) ||
                other.currentStep == currentStep) &&
            (identical(other.isPrefilled, isPrefilled) ||
                other.isPrefilled == isPrefilled) &&
            ...
            (identical(other.contactKakao, contactKakao) ||
                other.contactKakao == contactKakao) &&
            const DeepCollectionEquality()
                .equals(other._enabledContactMethods, _enabledContactMethods) &&
            (identical(other.balanceEnabled, balanceEnabled) ||
                other.balanceEnabled == balanceEnabled) &&
            (identical(other.balanceTolerance, balanceTolerance) ||
                other.balanceTolerance == balanceTolerance) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        contactEmail,
        contactKakao,
        const DeepCollectionEquality().hash(_enabledContactMethods),
        balanceEnabled,
        balanceTolerance,
...
/// @nodoc
abstract mixin class _$PartyCreateWizardStateCopyWith<$Res>
    implements $PartyCreateWizardStateCopyWith<$Res> {
  factory _$PartyCreateWizardStateCopyWith(_PartyCreateWizardState value,
          $Res Function(_PartyCreateWizardState) _then) =
      __$PartyCreateWizardStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {PartyCreateStep currentStep,
