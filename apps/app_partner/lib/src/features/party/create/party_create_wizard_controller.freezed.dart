...
@override
int get hashCode => Object.hash(runtimeType,currentStep,title,const DeepCollectionEquality().hash(description),const DeepCollectionEquality().hash(imageFiles),selectedLocation,addressDetail,directionsGuide,minConfirmedCount,maxParticipants,contactPhone,contactEmail,contactKakao,const DeepCollectionEquality().hash(enabledContactMethods),balanceEnabled,balanceTolerance,const DeepCollectionEquality().hash(entryGroups),const DeepCollectionEquality().hash(tickets),status);
...
/// Create a copy of PartyCreateWizardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentStep = null,Object? title = null,Object? description = null,Object? imageFiles = null,Object? selectedLocation = freezed,Object? addressDetail = null,Object? directionsGuide = null,Object? minConfirmedCount = null,Object? maxParticipants = null,Object? contactPhone = null,Object? contactEmail = null,Object? contactKakao = freezed,Object? enabledContactMethods = null,Object? balanceEnabled = null,Object? balanceTolerance = null,Object? entryGroups = null,Object? tickets = null,Object? status = null,}) {
...
class _PartyCreateWizardState implements PartyCreateWizardState {
  const _PartyCreateWizardState({this.currentStep = PartyCreateStep.basicInfo, this.title = '', final  Map<String, dynamic> description = const {}, final  List<XFile> imageFiles = const [], this.selectedLocation, this.addressDetail = '', this.directionsGuide = '', this.minConfirmedCount = 5, this.maxParticipants = 0, this.contactPhone = '', this.contactEmail = '', this.contactKakao, final  Set<String> enabledContactMethods = const {}, this.balanceEnabled = false, this.balanceTolerance = 2, final  List<EntryGroupTemplate> entryGroups = const [], final  List<TicketTemplate> tickets = const [], this.status = const AsyncValue.data(null)}): _description = description,_imageFiles = imageFiles,_enabledContactMethods = enabledContactMethods,_entryGroups = entryGroups,_tickets = tickets;
...
@override
int get hashCode => Object.hash(runtimeType,currentStep,title,const DeepCollectionEquality().hash(_description),const DeepCollectionEquality().hash(_imageFiles),selectedLocation,addressDetail,directionsGuide,minConfirmedCount,maxParticipants,contactPhone,contactEmail,contactKakao,const DeepCollectionEquality().hash(_enabledContactMethods),balanceEnabled,balanceTolerance,const DeepCollectionEquality().hash(_entryGroups),const DeepCollectionEquality().hash(_tickets),status);
