...
mixin _$PartnerDashboardState {
 ...
 int get pendingReviewCount; List<Event> get upcomingEvents; List<Event> get closingSoonEvents; List<Event> get liveEvents; List<Event> get recruitingEvents; List<Party> get activeParties; List<Party> get draftParties; int get totalPartyCount;// Fix #1215: tracks ALL events ever created, not just upcoming ones.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PartnerDashboardState&&(identical(other.pendingReviewCount, pendingReviewCount) || other.pendingReviewCount == pendingReviewCount)&&const DeepCollectionEquality().equals(other.upcomingEvents, upcomingEvents)&&const DeepCollectionEquality().equals(other.closingSoonEvents, closingSoonEvents)&&const DeepCollectionEquality().equals(other.liveEvents, liveEvents)&&const DeepCollectionEquality().equals(other.recruitingEvents, recruitingEvents)&&const DeepCollectionEquality().equals(other.activeParties, activeParties)&&const DeepCollectionEquality().equals(other.draftParties, draftParties)&&(identical(other.totalPartyCount, totalPartyCount) || other.totalPartyCount == totalPartyCount)&&(identical(other.hasAnyEvents, hasAnyEvents) || other.hasAnyEvents == hasAnyEvents)&&(identical(other.status, status) || other.status == status));
}


@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(upcomingEvents),const DeepCollectionEquality().hash(closingSoonEvents),const DeepCollectionEquality().hash(liveEvents),const DeepCollectionEquality().hash(recruitingEvents),const DeepCollectionEquality().hash(activeParties),const DeepCollectionEquality().hash(draftParties),totalPartyCount,hasAnyEvents,status);

@override
String toString() {
  return 'PartnerDashboardState(pendingReviewCount: $pendingReviewCount, upcomingEvents: $upcomingEvents, closingSoonEvents: $closingSoonEvents, liveEvents: $liveEvents, recruitingEvents: $recruitingEvents, activeParties: $activeParties, draftParties: $draftParties, totalPartyCount: $totalPartyCount, hasAnyEvents: $hasAnyEvents, status: $status)';
}
...
@useResult
$Res call({
 int pendingReviewCount, List<Event> upcomingEvents, List<Event> closingSoonEvents, List<Event> liveEvents, List<Event> recruitingEvents, List<Party> activeParties, List<Party> draftParties, int totalPartyCount, bool hasAnyEvents, AsyncValue<void> status
});
...
/// Create a copy of PartnerDashboardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pendingReviewCount = null,Object? upcomingEvents = null,Object? closingSoonEvents = null,Object? liveEvents = null,Object? recruitingEvents = null,Object? activeParties = null,Object? draftParties = null,Object? totalPartyCount = null,Object? hasAnyEvents = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int pendingReviewCount,  List<Event> upcomingEvents,  List<Event> closingSoonEvents,  List<Event> liveEvents,  List<Event> recruitingEvents,  List<Party> activeParties,  List<Party> draftParties,  int totalPartyCount,  bool hasAnyEvents,  AsyncValue<void> status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PartnerDashboardState() when $default != null:
return $default(_that.pendingReviewCount,_that.upcomingEvents,_that.closingSoonEvents,_that.liveEvents,_that.recruitingEvents,_that.activeParties,_that.draftParties,_that.totalPartyCount,_that.hasAnyEvents,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int pendingReviewCount,  List<Event> upcomingEvents,  List<Event> closingSoonEvents,  List<Event> liveEvents,  List<Event> recruitingEvents,  List<Party> activeParties,  List<Party> draftParties,  int totalPartyCount,  bool hasAnyEvents,  AsyncValue<void> status)  $default,) {final _that = this;
switch (_that) {
case _PartnerDashboardState():
return $default(_that.pendingReviewCount,_that.upcomingEvents,_that.closingSoonEvents,_that.liveEvents,_that.recruitingEvents,_that.activeParties,_that.draftParties,_that.totalPartyCount,_that.hasAnyEvents,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int pendingReviewCount,  List<Event> upcomingEvents,  List<Event> closingSoonEvents,  List<Event> liveEvents,  List<Event> recruitingEvents,  List<Party> activeParties,  List<Party> draftParties,  int totalPartyCount,  bool hasAnyEvents,  AsyncValue<void> status)?  $default,) {final _that = this;
switch (_that) {
case _PartnerDashboardState() when $default != null:
return $default(_that.pendingReviewCount,_that.upcomingEvents,_that.closingSoonEvents,_that.liveEvents,_that.recruitingEvents,_that.activeParties,_that.draftParties,_that.totalPartyCount,_that.hasAnyEvents,_that.status);case _:
  return null;
...
class _PartnerDashboardState implements PartnerDashboardState {
  const _PartnerDashboardState({this.pendingReviewCount = 0, final  List<Event> upcomingEvents = const [], final  List<Event> closingSoonEvents = const [], final  List<Event> liveEvents = const [], final  List<Event> recruitingEvents = const [], final  List<Party> activeParties = const [], final  List<Party> draftParties = const [], this.totalPartyCount = 0, this.hasAnyEvents = false, this.status = const AsyncValue<void>.loading()}): _upcomingEvents = upcomingEvents,_closingSoonEvents = closingSoonEvents,_liveEvents = liveEvents,_recruitingEvents = recruitingEvents,_activeParties = activeParties,_draftParties = draftParties;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PartnerDashboardState&&(identical(other.pendingReviewCount, pendingReviewCount) || other.pendingReviewCount == pendingReviewCount)&&const DeepCollectionEquality().equals(other._upcomingEvents, _upcomingEvents)&&const DeepCollectionEquality().equals(other._closingSoonEvents, _closingSoonEvents)&&const DeepCollectionEquality().equals(other._liveEvents, _liveEvents)&&const DeepCollectionEquality().equals(other._recruitingEvents, _recruitingEvents)&&const DeepCollectionEquality().equals(other._activeParties, _activeParties)&&const DeepCollectionEquality().equals(other._draftParties, _draftParties)&&(identical(other.totalPartyCount, totalPartyCount) || other.totalPartyCount == totalPartyCount)&&(identical(other.hasAnyEvents, hasAnyEvents) || other.hasAnyEvents == hasAnyEvents)&&(identical(other.status, status) || other.status == status));
}


@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(_upcomingEvents),const DeepCollectionEquality().hash(_closingSoonEvents),const DeepCollectionEquality().hash(_liveEvents),const DeepCollectionEquality().hash(_recruitingEvents),const DeepCollectionEquality().hash(_activeParties),const DeepCollectionEquality().hash(_draftParties),totalPartyCount,hasAnyEvents,status);
