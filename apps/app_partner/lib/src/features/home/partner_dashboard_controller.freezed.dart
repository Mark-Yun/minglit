...
mixin _$PartnerDashboardState {
 ...
 int get pendingReviewCount; List<Event> get todayEvents; bool get hasRevenuePermission; AsyncValue<void> get status;
...
@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(todayEvents),hasRevenuePermission,status);

@override
String toString() {
  return 'PartnerDashboardState(pendingReviewCount: $pendingReviewCount, todayEvents: $todayEvents, hasRevenuePermission: $hasRevenuePermission, status: $status)';
}
...
@useResult
$Res call({
 int pendingReviewCount, List<Event> todayEvents, bool hasRevenuePermission, AsyncValue<void> status
});
...
/// Create a copy of PartnerDashboardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pendingReviewCount = null,Object? todayEvents = null,Object? hasRevenuePermission = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int pendingReviewCount,  List<Event> todayEvents,  bool hasRevenuePermission,  AsyncValue<void> status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PartnerDashboardState() when $default != null:
return $default(_that.pendingReviewCount,_that.todayEvents,_that.hasRevenuePermission,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int pendingReviewCount,  List<Event> todayEvents,  bool hasRevenuePermission,  AsyncValue<void> status)  $default,) {final _that = this;
switch (_that) {
case _PartnerDashboardState():
return $default(_that.pendingReviewCount,_that.todayEvents,_that.hasRevenuePermission,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int pendingReviewCount,  List<Event> todayEvents,  bool hasRevenuePermission,  AsyncValue<void> status)?  $default,) {final _that = this;
switch (_that) {
case _PartnerDashboardState() when $default != null:
return $default(_that.pendingReviewCount,_that.todayEvents,_that.hasRevenuePermission,_that.status);case _:
  return null;
...
class _PartnerDashboardState implements PartnerDashboardState {
  const _PartnerDashboardState({this.pendingReviewCount = 0, final  List<Event> todayEvents = const [], this.hasRevenuePermission = false, this.status = const AsyncValue.loading()}): _todayEvents = todayEvents;
...
@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(_todayEvents),hasRevenuePermission,status);
...
/// Create a copy of PartnerDashboardState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pendingReviewCount = null,Object? todayEvents = null,Object? hasRevenuePermission = null,Object? status = null,}) {
