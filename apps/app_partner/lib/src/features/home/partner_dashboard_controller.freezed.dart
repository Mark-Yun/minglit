...
mixin _$PartnerDashboardState {
 ...
 int get pendingReviewCount; List<Event> get upcomingEvents; List<Event> get closingSoonEvents; List<Event> get liveEvents; List<Event> get recruitingEvents; List<Event> get preparingEvents; List<Party> get activeParties; List<Party> get draftParties; int get totalPartyCount; int get totalAttendees;// Fix #1215: tracks ALL events ever created, not just upcoming ones.
...
@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(upcomingEvents),const DeepCollectionEquality().hash(closingSoonEvents),const DeepCollectionEquality().hash(liveEvents),const DeepCollectionEquality().hash(recruitingEvents),const DeepCollectionEquality().hash(preparingEvents),const DeepCollectionEquality().hash(activeParties),const DeepCollectionEquality().hash(draftParties),totalPartyCount,totalAttendees,hasAnyEvents,status);
...
@useResult
$Res call({
 int pendingReviewCount, List<Event> upcomingEvents, List<Event> closingSoonEvents, List<Event> liveEvents, List<Event> recruitingEvents, List<Event> preparingEvents, List<Party> activeParties, List<Party> draftParties, int totalPartyCount, int totalAttendees, bool hasAnyEvents, AsyncValue<void> status
});
...
switch (_that) {
case _PartnerDashboardState() when $default != null:
return $default(_that.pendingReviewCount,_that.upcomingEvents,_that.closingSoonEvents,_that.liveEvents,_that.recruitingEvents,_that.preparingEvents,_that.activeParties,_that.draftParties,_that.totalPartyCount,_that.totalAttendees,_that.hasAnyEvents,_that.status);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,pendingReviewCount,const DeepCollectionEquality().hash(_upcomingEvents),const DeepCollectionEquality().hash(_closingSoonEvents),const DeepCollectionEquality().hash(_liveEvents),const DeepCollectionEquality().hash(_recruitingEvents),const DeepCollectionEquality().hash(_preparingEvents),const DeepCollectionEquality().hash(_activeParties),const DeepCollectionEquality().hash(_draftParties),totalPartyCount,totalAttendees,hasAnyEvents,status);
