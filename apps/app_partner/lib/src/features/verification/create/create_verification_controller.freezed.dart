...
mixin _$CreateVerificationState {
  ...
  List<VerificationFormField> get fields;
  String? get error;
  ...
  $CreateVerificationStateCopyWith<CreateVerificationState> get copyWith =>
      _$CreateVerificationStateCopyWithImpl<CreateVerificationState>(
          this as CreateVerificationState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CreateVerificationState &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, displayName, internalName,
      description, const DeepCollectionEquality().hash(fields), error);
...
abstract mixin class $CreateVerificationStateCopyWith<$Res> {
  factory $CreateVerificationStateCopyWith(CreateVerificationState value,
          $Res Function(CreateVerificationState) _then) =
      _$CreateVerificationStateCopyWithImpl;
  @useResult
  $Res call(
      {String displayName,
      String internalName,
      String description,
      List<VerificationFormField> fields,
      String? error});
}
...
extension CreateVerificationStatePatterns on CreateVerificationState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CreateVerificationState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _CreateVerificationState() when $default != null:
        return $default(_that.displayName, _that.internalName,
            _that.description, _that.fields, _that.error);
      case _:
        return orElse();
    }
  }
...
class _CreateVerificationState implements CreateVerificationState {
  const _CreateVerificationState(
      {this.displayName = '',
      this.internalName = '',
      this.description = '',
      final List<VerificationFormField> fields = const [],
      this.error})
      : _fields = fields;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CreateVerificationStateCopyWith<_CreateVerificationState> get copyWith =>
      __$CreateVerificationStateCopyWithImpl<_CreateVerificationState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CreateVerificationState &&
            (identical(other.displayName, displayName) ||
                other.displayName == displayName) &&
            (identical(other.internalName, internalName) ||
                other.internalName == internalName) &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, displayName, internalName,
      description, const DeepCollectionEquality().hash(_fields), error);
...
/// @nodoc
abstract mixin class _$CreateVerificationStateCopyWith<$Res>
    implements $CreateVerificationStateCopyWith<$Res> {
  factory _$CreateVerificationStateCopyWith(_CreateVerificationState value,
          $Res Function(_CreateVerificationState) _then) =
      __$CreateVerificationStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String displayName,
