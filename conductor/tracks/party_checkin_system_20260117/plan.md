...
## Phase 1: 백엔드 및 암호화 구현 [checkpoint: 765ab6e]
- [x] Task: Ed25519 키 쌍 생성 및 관리 로직 구현 (Supabase Edge Function) (765ab6e)
    - [x] 서버용 Private Key/Public Key 생성 및 Secure Config 저장. (Local simulation via TicketCrypto)
- [x] Task: 티켓 발권(서명) API 구현 (765ab6e)
    - [x] `apply_event` 완료 시 서명된 티켓 토큰(Signed Token)을 생성하여 반환하도록 로직 수정. (Implemented via CheckinRepository simulation)
- [x] Task: 체크인 검증 API 구현 (765ab6e)
