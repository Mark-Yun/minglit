...
| [edge-functions.md](docs/operations/edge-functions.md) | Edge Function 디버깅 (Axiom, Sentry, 로컬/Dev, 테스트) |
...
| `YY` | 연도 2자리 | `26` (2026년) |
| `MM` | 월 2자리 | `03` (3월) |
| `PR#` | 머지된 PR 번호 | `183`, `402`, `99` |

**예시**:
- `26.03.183` — 26년 3월, PR #183 머지
- `26.03.402` — 26년 3월, PR #402 머지
- `26.05.15` — 26년 5월, PR #15 머지
