...
void main() {
  group('AccountManagementPage', () {
    testWidgets('renders 계정 관리 AppBar and logout/delete tiles', (tester) async {
    ...
    testWidgets(
      'shows partner profile tile when onPartnerProfile is provided',
      (tester) async {
        await tester.pumpWidget(
    ...
    testWidgets('delete account tile invokes onDeleteAccount directly', (
      ...
      var called = false;
      await tester.pumpWidget(_buildPage(onDeleteAccount: () => called = true));
      await tester.pumpAndSettle();
