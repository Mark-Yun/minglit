...
class _Party extends Party {
  const _Party({required this.id, @JsonKey(name: 'partner_id') required this.partnerId, required this.title, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'location_id') this.locationId, @JsonKey(includeToJson: false) this.location, final  Map<String, dynamic>? description, @JsonKey(name: 'image_urls') final  List<String> imageUrls = const [], @JsonKey(name: 'contact_options') final  Map<String, dynamic> contactOptions = const {}, final  Map<String, dynamic> metadata = const {}, @JsonKey(name: 'required_verification_ids') final  List<String> requiredVerificationIds = const [], @JsonKey(name: 'min_confirmed_count') this.minConfirmedCount = 0, @JsonKey(name: 'max_participants') this.maxParticipants = 20, this.status = 'active', this.visibility = 'public', @JsonKey(includeToJson: false) final  List<TicketTemplate>? ticketTemplates, @JsonKey(includeToJson: false) this.partner, @JsonKey(name: 'entry_group_templates', includeToJson: false) final  List<EntryGroupTemplate>? entryGroups, @JsonKey(includeToJson: false) final  List<Tag>? tags}): _description = description,_imageUrls = imageUrls,_contactOptions = contactOptions,_metadata = metadata,_requiredVerificationIds = requiredVerificationIds,_ticketTemplates = ticketTemplates,_entryGroups = entryGroups,_tags = tags,super._();
