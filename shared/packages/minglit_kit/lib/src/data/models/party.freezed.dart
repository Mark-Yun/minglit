...
mixin _$Party {
 ...
 String get id;@JsonKey(name: 'partner_id') String get partnerId; String get title;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'location_id') String? get locationId;@JsonKey(includeToJson: false) Location? get location;@JsonKey(fromJson: _descriptionFromJson) Map<String, dynamic>? get description;// Quill Delta JSON
...
@useResult
$Res call({
 String id,@JsonKey(name: 'partner_id') String partnerId, String title,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'location_id') String? locationId,@JsonKey(includeToJson: false) Location? location,@JsonKey(fromJson: _descriptionFromJson) Map<String, dynamic>? description,@JsonKey(name: 'image_urls') List<String> imageUrls,@JsonKey(name: 'contact_options') Map<String, dynamic> contactOptions, Map<String, dynamic> metadata,@JsonKey(name: 'required_verification_ids') List<String> requiredVerificationIds,@JsonKey(name: 'min_confirmed_count') int minConfirmedCount,@JsonKey(name: 'max_participants') int maxParticipants, String status, String visibility,@JsonKey(includeToJson: false) List<TicketTemplate>? ticketTemplates,@JsonKey(includeToJson: false) Partner? partner,@JsonKey(name: 'entry_group_templates', includeToJson: false) List<EntryGroupTemplate>? entryGroups,@JsonKey(includeToJson: false) List<Tag>? tags
});
...
as List<EntryGroupTemplate>?,tags: freezed == tags ? _self.tags : tags // ignore: cast_nullable_to_non_nullable
as List<Tag>?,
  ));
}
/// Create a copy of Party
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'partner_id')  String partnerId,  String title, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'location_id')  String? locationId, @JsonKey(includeToJson: false)  Location? location, @JsonKey(fromJson: _descriptionFromJson)  Map<String, dynamic>? description, @JsonKey(name: 'image_urls')  List<String> imageUrls, @JsonKey(name: 'contact_options')  Map<String, dynamic> contactOptions,  Map<String, dynamic> metadata, @JsonKey(name: 'required_verification_ids')  List<String> requiredVerificationIds, @JsonKey(name: 'min_confirmed_count')  int minConfirmedCount, @JsonKey(name: 'max_participants')  int maxParticipants,  String status,  String visibility, @JsonKey(includeToJson: false)  List<TicketTemplate>? ticketTemplates, @JsonKey(includeToJson: false)  Partner? partner, @JsonKey(name: 'entry_group_templates', includeToJson: false)  List<EntryGroupTemplate>? entryGroups, @JsonKey(includeToJson: false)  List<Tag>? tags)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Party() when $default != null:
return $default(_that.id,_that.partnerId,_that.title,_that.createdAt,_that.updatedAt,_that.locationId,_that.location,_that.description,_that.imageUrls,_that.contactOptions,_that.metadata,_that.requiredVerificationIds,_that.minConfirmedCount,_that.maxParticipants,_that.status,_that.visibility,_that.ticketTemplates,_that.partner,_that.entryGroups,_that.tags);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'partner_id')  String partnerId,  String title, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'location_id')  String? locationId, @JsonKey(includeToJson: false)  Location? location, @JsonKey(fromJson: _descriptionFromJson)  Map<String, dynamic>? description, @JsonKey(name: 'image_urls')  List<String> imageUrls, @JsonKey(name: 'contact_options')  Map<String, dynamic> contactOptions,  Map<String, dynamic> metadata, @JsonKey(name: 'required_verification_ids')  List<String> requiredVerificationIds, @JsonKey(name: 'min_confirmed_count')  int minConfirmedCount, @JsonKey(name: 'max_participants')  int maxParticipants,  String status,  String visibility, @JsonKey(includeToJson: false)  List<TicketTemplate>? ticketTemplates, @JsonKey(includeToJson: false)  Partner? partner, @JsonKey(name: 'entry_group_templates', includeToJson: false)  List<EntryGroupTemplate>? entryGroups, @JsonKey(includeToJson: false)  List<Tag>? tags)  $default,) {final _that = this;
switch (_that) {
case _Party():
return $default(_that.id,_that.partnerId,_that.title,_that.createdAt,_that.updatedAt,_that.locationId,_that.location,_that.description,_that.imageUrls,_that.contactOptions,_that.metadata,_that.requiredVerificationIds,_that.minConfirmedCount,_that.maxParticipants,_that.status,_that.visibility,_that.ticketTemplates,_that.partner,_that.entryGroups,_that.tags);case _:
  throw StateError('Unexpected subclass');
...
class _Party extends Party {
  const _Party({required this.id, @JsonKey(name: 'partner_id') required this.partnerId, required this.title, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'location_id') this.locationId, @JsonKey(includeToJson: false) this.location, @JsonKey(fromJson: _descriptionFromJson) final  Map<String, dynamic>? description, @JsonKey(name: 'image_urls') final  List<String> imageUrls = const [], @JsonKey(name: 'contact_options') final  Map<String, dynamic> contactOptions = const {}, final  Map<String, dynamic> metadata = const {}, @JsonKey(name: 'required_verification_ids') final  List<String> requiredVerificationIds = const [], @JsonKey(name: 'min_confirmed_count') this.minConfirmedCount = 0, @JsonKey(name: 'max_participants') this.maxParticipants = 20, this.status = 'active', this.visibility = 'public', @JsonKey(includeToJson: false) final  List<TicketTemplate>? ticketTemplates, @JsonKey(includeToJson: false) this.partner, @JsonKey(name: 'entry_group_templates', includeToJson: false) final  List<EntryGroupTemplate>? entryGroups, @JsonKey(includeToJson: false) final  List<Tag>? tags}): _description = description,_imageUrls = imageUrls,_contactOptions = contactOptions,_metadata = metadata,_requiredVerificationIds = requiredVerificationIds,_ticketTemplates = ticketTemplates,_entryGroups = entryGroups,_tags = tags,super._();
...
@override@JsonKey(fromJson: _descriptionFromJson) Map<String, dynamic>? get description {
...
as List<EntryGroupTemplate>?,tags: freezed == tags ? _self._tags : tags // ignore: cast_nullable_to_non_nullable
as List<Tag>?,
  ));
}
