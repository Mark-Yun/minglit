...
mixin _$EventApplication {
 ...
 String get id;@JsonKey(name: 'event_id') String get eventId;@JsonKey(name: 'ticket_id') String get ticketId;@JsonKey(name: 'user_id') String get userId;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt; String get status; String? get message;@JsonKey(name: 'payment_id') String? get paymentId;@JsonKey(name: 'payment_amount') int? get paymentAmount;@JsonKey(name: 'refund_status') String get refundStatus;// Relationships
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,eventId,ticketId,userId,createdAt,updatedAt,status,message,paymentId,paymentAmount,refundStatus,event,ticket);

@override
String toString() {
  return 'EventApplication(id: $id, eventId: $eventId, ticketId: $ticketId, userId: $userId, createdAt: $createdAt, updatedAt: $updatedAt, status: $status, message: $message, paymentId: $paymentId, paymentAmount: $paymentAmount, refundStatus: $refundStatus, event: $event, ticket: $ticket)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'event_id') String eventId,@JsonKey(name: 'ticket_id') String ticketId,@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt, String status, String? message,@JsonKey(name: 'payment_id') String? paymentId,@JsonKey(name: 'payment_amount') int? paymentAmount,@JsonKey(name: 'refund_status') String refundStatus, Event? event, Ticket? ticket
});
...
/// Create a copy of EventApplication
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? eventId = null,Object? ticketId = null,Object? userId = null,Object? createdAt = null,Object? updatedAt = null,Object? status = null,Object? message = freezed,Object? paymentId = freezed,Object? paymentAmount = freezed,Object? refundStatus = null,Object? event = freezed,Object? ticket = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'event_id')  String eventId, @JsonKey(name: 'ticket_id')  String ticketId, @JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt,  String status,  String? message, @JsonKey(name: 'payment_id')  String? paymentId, @JsonKey(name: 'payment_amount')  int? paymentAmount, @JsonKey(name: 'refund_status')  String refundStatus,  Event? event,  Ticket? ticket)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EventApplication() when $default != null:
return $default(_that.id,_that.eventId,_that.ticketId,_that.userId,_that.createdAt,_that.updatedAt,_that.status,_that.message,_that.paymentId,_that.paymentAmount,_that.refundStatus,_that.event,_that.ticket);case _:
  return orElse();
...
/// Create a copy of EventApplication
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? eventId = null,Object? ticketId = null,Object? userId = null,Object? createdAt = null,Object? updatedAt = null,Object? status = null,Object? message = freezed,Object? paymentId = freezed,Object? paymentAmount = freezed,Object? refundStatus = null,Object? event = freezed,Object? ticket = freezed,}) {
