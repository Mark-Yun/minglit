...
@useResult
$Res call({
 String id,@JsonKey(name: 'party_id') String partyId,@JsonKey(name: 'start_time') DateTime startTime,@JsonKey(name: 'end_time') DateTime endTime,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'location_id') String? locationId, String? title,@JsonKey(fromJson: _descriptionFromJson) Map<String, dynamic>? description,@JsonKey(name: 'image_urls') List<String>? imageUrls,@JsonKey(name: 'contact_options') Map<String, dynamic> contactOptions, Map<String, dynamic> metadata,@JsonKey(name: 'min_confirmed_count') int minConfirmedCount,@JsonKey(name: 'max_participants') int maxParticipants,@JsonKey(name: 'current_participants') int currentParticipants, String status, String? visibility,@JsonKey(includeToJson: false) Location? location,@JsonKey(includeToJson: false) Party? party,@JsonKey(includeToJson: false) List<Ticket>? tickets,@JsonKey(includeToJson: false) List<EntryGroup>? entryGroups,@JsonKey(name: 'remaining_slots', includeToJson: false) int? remainingSlots,@JsonKey(name: 'distance_meters', includeToJson: false) double? distanceMeters,@JsonKey(includeToJson: false) bool? eligible,@JsonKey(includeToJson: false) List<Tag>? tags
});
...
as List<EntryGroup>?,remainingSlots: freezed == remainingSlots ? _self.remainingSlots : remainingSlots // ignore: cast_nullable_to_non_nullable
as int?,distanceMeters: freezed == distanceMeters ? _self.distanceMeters : distanceMeters // ignore: cast_nullable_to_non_nullable
as double?,eligible: freezed == eligible ? _self.eligible : eligible // ignore: cast_nullable_to_non_nullable
...
class _Event extends Event {
  const _Event({required this.id, @JsonKey(name: 'party_id') required this.partyId, @JsonKey(name: 'start_time') required this.startTime, @JsonKey(name: 'end_time') required this.endTime, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'location_id') this.locationId, this.title, @JsonKey(fromJson: _descriptionFromJson) final  Map<String, dynamic>? description, @JsonKey(name: 'image_urls') final  List<String>? imageUrls, @JsonKey(name: 'contact_options') final  Map<String, dynamic> contactOptions = const {}, final  Map<String, dynamic> metadata = const {}, @JsonKey(name: 'min_confirmed_count') this.minConfirmedCount = 0, @JsonKey(name: 'max_participants') this.maxParticipants = 20, @JsonKey(name: 'current_participants') this.currentParticipants = 0, this.status = 'scheduled', this.visibility, @JsonKey(includeToJson: false) this.location, @JsonKey(includeToJson: false) this.party, @JsonKey(includeToJson: false) final  List<Ticket>? tickets, @JsonKey(includeToJson: false) final  List<EntryGroup>? entryGroups, @JsonKey(name: 'remaining_slots', includeToJson: false) this.remainingSlots, @JsonKey(name: 'distance_meters', includeToJson: false) this.distanceMeters, @JsonKey(includeToJson: false) this.eligible, @JsonKey(includeToJson: false) final  List<Tag>? tags}): _description = description,_imageUrls = imageUrls,_contactOptions = contactOptions,_metadata = metadata,_tickets = tickets,_entryGroups = entryGroups,_tags = tags,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Event&&(identical(other.id, id) || other.id == id)&&(identical(other.partyId, partyId) || other.partyId == partyId)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.locationId, locationId) || other.locationId == locationId)&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._description, _description)&&const DeepCollectionEquality().equals(other._imageUrls, _imageUrls)&&const DeepCollectionEquality().equals(other._contactOptions, _contactOptions)&&const DeepCollectionEquality().equals(other._metadata, _metadata)&&(identical(other.minConfirmedCount, minConfirmedCount) || other.minConfirmedCount == minConfirmedCount)&&(identical(other.maxParticipants, maxParticipants) || other.maxParticipants == maxParticipants)&&(identical(other.currentParticipants, currentParticipants) || other.currentParticipants == currentParticipants)&&(identical(other.status, status) || other.status == status)&&(identical(other.visibility, visibility) || other.visibility == visibility)&&(identical(other.location, location) || other.location == location)&&(identical(other.party, party) || other.party == party)&&const DeepCollectionEquality().equals(other._tickets, _tickets)&&const DeepCollectionEquality().equals(other._entryGroups, _entryGroups)&&(identical(other.remainingSlots, remainingSlots) || other.remainingSlots == remainingSlots)&&(identical(other.distanceMeters, distanceMeters) || other.distanceMeters == distanceMeters)&&(identical(other.eligible, eligible) || other.eligible == eligible)&&const DeepCollectionEquality().equals(other._tags, _tags));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,partyId,startTime,endTime,createdAt,updatedAt,locationId,title,const DeepCollectionEquality().hash(_description),const DeepCollectionEquality().hash(_imageUrls),const DeepCollectionEquality().hash(_contactOptions),const DeepCollectionEquality().hash(_metadata),minConfirmedCount,maxParticipants,currentParticipants,status,visibility,location,party,const DeepCollectionEquality().hash(_tickets),const DeepCollectionEquality().hash(_entryGroups),remainingSlots,distanceMeters,eligible,const DeepCollectionEquality().hash(_tags)]);
