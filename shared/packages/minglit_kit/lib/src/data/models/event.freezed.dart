...
@JsonKey(name: 'remaining_slots', includeToJson: false) int? get remainingSlots;@JsonKey(name: 'distance_meters', includeToJson: false) double? get distanceMeters;@JsonKey(includeToJson: false) bool? get eligible;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,partyId,startTime,endTime,createdAt,updatedAt,locationId,title,const DeepCollectionEquality().hash(_description),const DeepCollectionEquality().hash(_imageUrls),const DeepCollectionEquality().hash(_contactOptions),const DeepCollectionEquality().hash(_metadata),minConfirmedCount,maxParticipants,currentParticipants,status,visibility,location,party,const DeepCollectionEquality().hash(_tickets),const DeepCollectionEquality().hash(_entryGroups),remainingSlots,distanceMeters,eligible]);
