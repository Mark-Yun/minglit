...
_EventTicket _$EventTicketFromJson(Map<String, dynamic> json) => _EventTicket(
  ...
  minBirthYear: (json['min_birth_year'] as num?)?.toInt(),
  maxBirthYear: (json['max_birth_year'] as num?)?.toInt(),
...
Map<String, dynamic> _$EventTicketToJson(_EventTicket instance) =>
    <String, dynamic>{
      ...
      'min_birth_year': instance.minBirthYear,
      'max_birth_year': instance.maxBirthYear,
