...
VALUES
  ...
  ('public', 'social_interactions', 'Users can create own interactions'),
  ('public', 'social_interactions', 'Users can delete own interactions'),
  ('public', 'social_interactions', 'Users can update own interactions'),
