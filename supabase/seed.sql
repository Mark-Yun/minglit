...
-- ── Phase 2 (retention-policies): Dev retention overrides ──────────────────
-- Dev: 짧은 retention 으로 디스크 절약 (main 은 migration 기본값 유지)
UPDATE admin.retention_policies SET retention_days = CASE id
